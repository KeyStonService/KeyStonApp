...
[Quick Start](#-quick-start) • [System Overview](#-system-overview) • [Core Features](#-core-features) •
[Living Knowledge Base](#4️⃣-living-knowledge-base) • [Admin Copilot CLI](#-admin-copilot-cli-public-preview) • [Web Apps](#-web-ui--code-analysis-api-appsweb) •
[Config Overview](#️-global-configuration-overview) • [Virtual Experts](#-virtual-expert-team) • [Agent Services](#-agent-services) •
[Drone System](#-drone-system-configuration) • [Autonomous Framework](#-autonomous-framework-drone--av) •
...
| ------------------------- | -------------------------------------------------------------------------- |
| **Single Entry Point**    | machinenativeops.yaml as the single source of truth     |
...
Node.js >= 18.0.0
  ...
  - machinenativeops.yaml – unified configuration entry
...
- machinenativeops.yaml – global entry
...
## 🚁 Drone System Configuration
  ...
  Drone fleet and automation configuration is defined in config/drone-config.yml and implemented by automation/autonomous/.
